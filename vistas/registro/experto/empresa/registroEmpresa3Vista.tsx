...
export default class RegistroEmpresa3Vista extends Component {
			...
			<ScrollView style={{ flex: 1, backgroundColor: "#FFFFFF" }}>
				...
				<View style={{ display: (this.state["selected"]) ? "none" : "flex" }}>
					...
					<View style={{ flex: 1, flexDirection: "row", alignItems: "center", marginHorizontal: 20 }}>
						...
						<Text style={{ flex: 0.9, marginLeft: 5, fontSize: 16 }}>Elige las ciudades donde ofrecerás tus servicios *</Text>
					</View>
				</View>
				...
				<Region ruta="RegistroEmpresa4" navigation={this.props["navigation"]} single={false} type="emp" selected={this.selected} />
			</ScrollView>
		)
	}
}
